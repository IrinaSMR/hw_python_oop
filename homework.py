...
class Training:
    ...
    def get_mean_speed(self) -> float:
        ...
        mean_speed = distance / self.duration_h
        return mean_speed
    ...
    def show_training_info(self) -> InfoMessage:
        ...
        info_message = (InfoMessage(self.__class__.__name__, self.duration_h,
...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        spent_calories = ((self.С_CAL_1 * self.get_mean_speed()
                          - self.C_CAL_2) * self.weight_kg / self.M_IN_KM
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        spent_calories = ((self.K_1 * self.weight_kg
